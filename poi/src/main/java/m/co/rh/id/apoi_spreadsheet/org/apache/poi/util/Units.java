...
public class Units {
    ...
    public static Rect pointsToPixel(Rect pointsDim) {
        int x = pointsDim.left * PIXEL_DPI / POINT_DPI;
        int y = pointsDim.top * PIXEL_DPI / POINT_DPI;
        int width = pointsDim.width() * PIXEL_DPI / POINT_DPI;
        int height = pointsDim.height() * PIXEL_DPI / POINT_DPI;
        return new Rect(x, y, width, height);
    }

    public static Rect pixelToPoints(Rect pointsDim) {
        int x = pointsDim.left * POINT_DPI / PIXEL_DPI;
        int y = pointsDim.top * POINT_DPI / PIXEL_DPI;
        int width = pointsDim.width() * POINT_DPI / PIXEL_DPI;
        int height = pointsDim.height() * POINT_DPI / PIXEL_DPI;
        return new Rect(x, y, width, height);
    }
