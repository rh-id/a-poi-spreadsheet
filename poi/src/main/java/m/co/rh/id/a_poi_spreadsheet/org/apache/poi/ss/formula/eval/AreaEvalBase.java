...
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.formula.SheetRange;
...
public abstract class AreaEvalBase implements AreaEval {
    ...
    */
     ...
     * @see m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.formula.TwoDEval#isRowHidden(int)
     */
    @Override
