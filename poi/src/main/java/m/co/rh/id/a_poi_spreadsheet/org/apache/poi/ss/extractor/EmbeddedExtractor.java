...
package m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.extractor;

import static m.co.rh.id.a_poi_spreadsheet.org.apache.poi.util.StringUtil.endsWithIgnoreCase;
...
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.poifs.filesystem.DocumentInputStream;
...
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.poifs.filesystem.Ole10NativeException;
...
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.usermodel.ObjectData;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.usermodel.Picture;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.usermodel.PictureData;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.usermodel.Shape;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.usermodel.ShapeContainer;
...
public class EmbeddedExtractor implements Iterable<EmbeddedExtractor> {
    private static final String TAG = "EmbeddedExtractor";
