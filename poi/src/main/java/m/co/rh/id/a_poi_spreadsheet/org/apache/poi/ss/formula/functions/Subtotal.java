...
import static m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.formula.functions.AggregateFunction.subtotalInstance;
...
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.formula.LazyRefEval;
...
public class Subtotal implements Function {
    ...
    private static Function findFunction(int functionCode) throws EvaluationException {
        switch (functionCode) {
            case 1:
                return subtotalInstance(AggregateFunction.AVERAGE, true);
            case 2:
                return Count.subtotalInstance(true);
            case 3:
                return Counta.subtotalInstance(true);
            case 4:
                return subtotalInstance(AggregateFunction.MAX, true);
            case 5:
                return subtotalInstance(AggregateFunction.MIN, true);
            case 6:
                return subtotalInstance(AggregateFunction.PRODUCT, true);
            case 7:
                return subtotalInstance(AggregateFunction.STDEV, true);
            case 8:
                return subtotalInstance(AggregateFunction.STDEVP, true);
            case 9:
                return subtotalInstance(AggregateFunction.SUM, true);
            case 10:
                return subtotalInstance(AggregateFunction.VAR, true);
            case 11:
                return subtotalInstance(AggregateFunction.VARP, true);
            case 101:
                return subtotalInstance(AggregateFunction.AVERAGE, false);
            case 102:
                return Count.subtotalInstance(false);
            case 103:
                return Counta.subtotalInstance(false);
            case 104:
                return subtotalInstance(AggregateFunction.MAX, false);
            case 105:
                return subtotalInstance(AggregateFunction.MIN, false);
            case 106:
                return subtotalInstance(AggregateFunction.PRODUCT, false);
            case 107:
                return subtotalInstance(AggregateFunction.STDEV, false);
            case 108:
                return subtotalInstance(AggregateFunction.STDEVP, false);
            case 109:
                return subtotalInstance(AggregateFunction.SUM, false);
            case 110:
                return subtotalInstance(AggregateFunction.VAR, false);
            case 111:
                return subtotalInstance(AggregateFunction.VARP, false);
        }
