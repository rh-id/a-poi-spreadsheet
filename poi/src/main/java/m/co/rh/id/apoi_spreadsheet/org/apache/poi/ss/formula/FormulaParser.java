...
import m.co.rh.id.apoi_spreadsheet.org.apache.poi.ss.formula.constant.ErrorConstant;
...
import m.co.rh.id.apoi_spreadsheet.org.apache.poi.ss.formula.ptg.FuncPtg;
...
import m.co.rh.id.apoi_spreadsheet.org.apache.poi.ss.formula.ptg.ParenthesisPtg;
...
import m.co.rh.id.apoi_spreadsheet.org.apache.poi.ss.formula.ptg.ValueOperatorPtg;
...
import m.co.rh.id.apoi_spreadsheet.org.apache.poi.ss.util.CellReference.NameType;
...
public final class FormulaParser {
    private static final String LOGGER_TAG = "FormulaParser";
        ...
        if(!AbstractFunctionPtg.isBuiltInFunctionName(name)) {
            ...
            if (hName != null) {
                ...
                if (nameToken == null) {
                    ...
                    Log.w(LOGGER_TAG, String.format("FormulaParser.function: Name '%s' is completely unknown in the current workbook.", name));
