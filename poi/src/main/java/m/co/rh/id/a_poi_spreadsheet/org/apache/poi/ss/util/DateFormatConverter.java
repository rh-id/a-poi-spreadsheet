...
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.util.LocaleID;
...
public final class DateFormatConverter {
    ...
    public static String getPrefixForLocale(Locale locale) {
        ...
        if (loc == null) {
            Log.e(TAG, String.format("Unable to find prefix for Locale '%s' or its parent locales.", languageTag));
            return "";
        }
