...
import static m.co.rh.id.a_poi_spreadsheet.org.apache.poi.util.Units.EMU_PER_PIXEL;
...
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.hssf.usermodel.HSSFClientAnchor;
    ...
    public static Dimension getImageDimension(InputStream is, int type) {
        ...
        switch (type) {
            ...
            case Workbook.PICTURE_TYPE_DIB:
                ...
                break;
            default:
                Log.w(TAG, "Only JPEG, PNG and DIB pictures can be automatically sized");
        }
        return size;
    }
