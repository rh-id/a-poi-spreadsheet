...
package m.co.rh.id.a_poi_spreadsheet.org.apache.poi.poifs.crypt.standard;

import static m.co.rh.id.a_poi_spreadsheet.org.apache.poi.poifs.crypt.DataSpaceMapUtils.createEncryptionEntry;
import static m.co.rh.id.a_poi_spreadsheet.org.apache.poi.poifs.crypt.standard.StandardDecryptor.generateSecretKey;
...
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.poifs.filesystem.POIFSWriterEvent;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.poifs.filesystem.POIFSWriterListener;
    ...
    protected class StandardCipherOutputStream extends FilterOutputStream implements POIFSWriterListener {
        ...
        public void processPOIFSWriterEvent(POIFSWriterEvent event) {
            try {
                ...
                if (!fileOut.delete()) {
                    Log.e(TAG, String.format("Can't delete temporary encryption file: %s", fileOut));
                }
