...
public class TypedPropertyValue {
    private static final String TAG = "TypedPropertyValue";
    ...
    public void read(LittleEndianByteArrayInputStream lei) {
        ...
        if (padding != 0) {
            Log.w(TAG, String.format("TypedPropertyValue padding at offset %d MUST be 0, but it's value is %d", lei.getReadIndex(), padding));
        }
        readValue(lei);
    }
