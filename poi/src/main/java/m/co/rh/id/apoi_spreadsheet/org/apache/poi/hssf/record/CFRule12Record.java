...
import static m.co.rh.id.apoi_spreadsheet.org.apache.poi.hssf.usermodel.HSSFWorkbook.getMaxRecordLength;
...
import m.co.rh.id.apoi_spreadsheet.org.apache.poi.hssf.record.cf.ColorGradientFormatting;
import m.co.rh.id.apoi_spreadsheet.org.apache.poi.hssf.record.cf.ColorGradientThreshold;
import m.co.rh.id.apoi_spreadsheet.org.apache.poi.hssf.record.cf.DataBarFormatting;
import m.co.rh.id.apoi_spreadsheet.org.apache.poi.hssf.record.cf.DataBarThreshold;
import m.co.rh.id.apoi_spreadsheet.org.apache.poi.hssf.record.cf.IconMultiStateFormatting;
import m.co.rh.id.apoi_spreadsheet.org.apache.poi.hssf.record.cf.IconMultiStateThreshold;
import m.co.rh.id.apoi_spreadsheet.org.apache.poi.hssf.record.cf.Threshold;
import m.co.rh.id.apoi_spreadsheet.org.apache.poi.hssf.record.common.ExtendedColor;
import m.co.rh.id.apoi_spreadsheet.org.apache.poi.hssf.record.common.FtrHeader;
import m.co.rh.id.apoi_spreadsheet.org.apache.poi.hssf.record.common.FutureRecord;
...
import m.co.rh.id.apoi_spreadsheet.org.apache.poi.ss.usermodel.ConditionalFormattingThreshold.RangeType;
import m.co.rh.id.apoi_spreadsheet.org.apache.poi.ss.usermodel.IconMultiStateFormatting.IconSet;
...
public final class CFRule12Record extends CFRuleBase implements FutureRecord {
    ...
    private static final String TAG = "CFRule12Record";
    ...
    public CFRule12Record(RecordInputStream in) {
        ...
        if (template_param_length == 0 || template_param_length == 16) {
            ...
            Log.w(TAG, String.format("CF Rule v12 template params length should be 0 or 16, found %d", template_param_length));
            in.readRemainder();
        }
