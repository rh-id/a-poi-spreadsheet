...
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.SpreadsheetVersion;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.formula.CollaboratingWorkbooksEnvironment.WorkbookNotFoundException;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.formula.atp.AnalysisToolPak;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.formula.eval.AreaEval;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.formula.eval.BlankEval;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.formula.eval.BoolEval;
...
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.formula.eval.ExternalNameEval;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.formula.eval.FunctionEval;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.formula.eval.FunctionNameEval;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.formula.eval.MissingArgEval;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.formula.eval.NotImplementedException;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.formula.eval.NumberEval;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.formula.eval.OperandResolver;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.formula.eval.RefListEval;
...
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.formula.functions.ArrayMode;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.formula.functions.Choose;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.formula.functions.FreeRefFunction;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.formula.functions.Function;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.formula.functions.IfFunc;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.formula.ptg.Area3DPtg;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.formula.ptg.Area3DPxg;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.formula.ptg.AreaErrPtg;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.formula.ptg.AreaPtg;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.formula.ptg.ArrayPtg;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.formula.ptg.AttrPtg;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.formula.ptg.BoolPtg;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.formula.ptg.ControlPtg;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.formula.ptg.DeletedArea3DPtg;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.formula.ptg.DeletedRef3DPtg;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.formula.ptg.ErrPtg;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.formula.ptg.ExpPtg;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.formula.ptg.FuncVarPtg;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.formula.ptg.IntPtg;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.formula.ptg.MemAreaPtg;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.formula.ptg.MemErrPtg;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.formula.ptg.MemFuncPtg;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.formula.ptg.MissingArgPtg;
...
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.formula.ptg.NameXPxg;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.formula.ptg.NumberPtg;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.formula.ptg.OperationPtg;
...
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.formula.ptg.Ref3DPxg;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.formula.ptg.RefErrorPtg;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.formula.ptg.RefPtg;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.formula.ptg.RefPtgBase;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.formula.ptg.StringPtg;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.formula.ptg.UnionPtg;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.formula.ptg.UnknownPtg;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.formula.udf.AggregatingUDFFinder;
...
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.util.CellRangeAddressBase;
...
public final class WorkbookEvaluator {
    ...
    private static final String TAG = "WorkbookEvaluator";
        ...
        if (cce.getValue() == null) {
            ...
            try {
                ...
                if (re.getCause() instanceof WorkbookNotFoundException && _ignoreMissingWorkbooks) {
                    Log.i(TAG, String.format("%s - Continuing with cached value!", re.getCause().getMessage()));
    ...
    private NotImplementedException addExceptionInfo(NotImplementedException inner, int sheetIndex, int rowIndex, int columnIndex) {
        ...
        try {
            ...
            Log.e(TAG, "Can't add exception info", e);
    ...
    /* package */ ValueEval evaluateFormula(OperationEvaluationContext ec, Ptg[] ptgs) {
        ...
        if (dbgEvaluationOutputIndent > 0) {
            ...
            if (Log.isLoggable(EVAL_TAG, Log.WARN)) {
                String message = String.format("%s - evaluateFormula('%s'/%s): %s", finalDbgIndentStr,
                        ec.getRefEvaluatorForCurrentSheet().getSheetNameRange(),
...
//            logDebug("push " + opResult);
            stack.push(opResult);
            if (dbgEvaluationOutputIndent > 0) {
                Log.i(EVAL_TAG, String.format("%s    = %s", dbgIndentStr, opResult));
            }
        }
