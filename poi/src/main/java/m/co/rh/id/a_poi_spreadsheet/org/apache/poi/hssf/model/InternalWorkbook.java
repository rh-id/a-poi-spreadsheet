...
package m.co.rh.id.a_poi_spreadsheet.org.apache.poi.hssf.model;
...
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ddf.EscherBSERecord;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ddf.EscherBoolProperty;
...
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ddf.EscherDggRecord;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ddf.EscherOptRecord;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ddf.EscherPropertyTypes;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ddf.EscherRGBProperty;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ddf.EscherRecord;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ddf.EscherSimpleProperty;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ddf.EscherSpRecord;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ddf.EscherSplitMenuColorsRecord;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.hssf.extractor.OldExcelExtractor;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.hssf.record.BOFRecord;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.hssf.record.BackupRecord;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.hssf.record.BookBoolRecord;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.hssf.record.BoundSheetRecord;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.hssf.record.CodepageRecord;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.hssf.record.CountryRecord;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.hssf.record.DSFRecord;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.hssf.record.DateWindow1904Record;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.hssf.record.DrawingGroupRecord;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.hssf.record.EOFRecord;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.hssf.record.EscherAggregate;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.hssf.record.ExtSSTRecord;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.hssf.record.ExtendedFormatRecord;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.hssf.record.ExternSheetRecord;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.hssf.record.FileSharingRecord;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.hssf.record.FnGroupCountRecord;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.hssf.record.FontRecord;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.hssf.record.FormatRecord;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.hssf.record.HideObjRecord;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.hssf.record.HyperlinkRecord;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.hssf.record.InterfaceEndRecord;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.hssf.record.InterfaceHdrRecord;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.hssf.record.MMSRecord;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.hssf.record.NameCommentRecord;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.hssf.record.NameRecord;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.hssf.record.PaletteRecord;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.hssf.record.PasswordRecord;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.hssf.record.PasswordRev4Record;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.hssf.record.PrecisionRecord;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.hssf.record.ProtectRecord;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.hssf.record.ProtectionRev4Record;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.hssf.record.RecalcIdRecord;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.hssf.record.Record;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.hssf.record.RefreshAllRecord;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.hssf.record.SSTRecord;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.hssf.record.StyleRecord;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.hssf.record.SupBookRecord;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.hssf.record.TabIdRecord;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.hssf.record.UseSelFSRecord;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.hssf.record.WindowOneRecord;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.hssf.record.WindowProtectRecord;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.hssf.record.WriteAccessRecord;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.hssf.record.WriteProtectRecord;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.hssf.record.common.UnicodeString;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.hssf.usermodel.HSSFWorkbook;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.hssf.util.HSSFColor.HSSFColorPredefined;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.poifs.crypt.CryptoFunctions;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.formula.EvaluationWorkbook.ExternalName;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.formula.EvaluationWorkbook.ExternalSheet;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.formula.EvaluationWorkbook.ExternalSheetRange;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.formula.FormulaShifter;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.formula.ptg.Area3DPtg;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.formula.ptg.NameXPtg;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.formula.ptg.OperandPtg;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.formula.ptg.Ptg;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.formula.ptg.Ref3DPtg;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.formula.udf.UDFFinder;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.usermodel.BuiltinFormats;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.usermodel.SheetVisibility;
...
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.util.LocaleUtil;
...
public final class InternalWorkbook {
    ...
    private static final String TAG = "InternalWorkbook";
    ...
    public static InternalWorkbook createWorkbook(List<Record> recs) {
        Log.d(TAG, String.format("Workbook (readfile) created with reclen=%d", recs.size()));
        ...
        for (int k = 0; k < recs.size(); k++) {
            ...
            switch (rec.getSid()) {
                ...
                case SupBookRecord.sid:
                    ...
                    Log.d(TAG, String.format("found SupBook record at %d", k));
            ...
            Log.i(TAG, String.format("found %s record at %d", logObj, k));
        ...
        Log.d(TAG, "exit create workbook from existing file function");
        return retval;
    }
    ...
    public static InternalWorkbook createWorkbook() {
        Log.d(TAG, "creating new workbook from scratch");
        ...
        Log.d(TAG, "exit create new workbook from scratch");
    ...
    public void setSheetBof(int sheetIndex, int pos) {
        Log.d(TAG, String.format("setting bof for sheetnum =%d at pos=%d", sheetIndex, pos));
    ...
    public int getNumSheets() {
        Log.d(TAG, String.format("getNumSheets={}", boundsheets.size()));
    ...
    public int getNumExFormats() {
        Log.d(TAG, String.format("getXF=%d", numxfs));
        return numxfs;
    }
    ...
    public int addSSTString(UnicodeString string) {
        Log.d(TAG, String.format("insert to sst string='%s'", string));
        if (sst == null) {
            insertSST();
        }
    ...
    public UnicodeString getSSTString(int str) {
        ...
        Log.i(TAG, String.format("Returning SST for index=%d String= %s", str, retval));
        return retval;
    }
    ...
    public void insertSST() {
        Log.d(TAG, "creating new SST via insertSST!");
    ...
    public int serialize(int offset, byte[] data) {
        Log.d(TAG, "Serializing Workbook with offsets");
        ...
        Log.d(TAG, "Exiting serialize workbook");
        return pos;
    }
    ...
    private static WriteAccessRecord createWriteAccess() {
        ...
        try {
            ...
            Log.w(TAG, "can't determine user.name", e);
    ...
    private static ExtendedFormatRecord createExtendedFormat(int id) {
        ...
        switch (id) {
            case 0:
                return createExtendedFormat(0, 0, 0xfffffff5, 0);
            case 1:
            case 2:
                return createExtendedFormat(1, 0, 0xfffffff5, 0xfffff400);
            case 3:
            case 4:
                return createExtendedFormat(2, 0, 0xfffffff5, 0xfffff400);
            case 5:
            case 6:
            case 7:
            case 8:
            ...
            case 13:
            case 14:
                return createExtendedFormat(0, 0, 0xfffffff5, 0xfffff400);
            // cell records
            case 15:
                return createExtendedFormat(0, 0, 1, 0);
            // style
            case 16:
                return createExtendedFormat(1, 0x2b, 0xfffffff5, 0xfffff800);
            case 17:
                return createExtendedFormat(1, 0x29, 0xfffffff5, 0xfffff800);
            case 18:
                return createExtendedFormat(1, 0x2c, 0xfffffff5, 0xfffff800);
            case 19:
                return createExtendedFormat(1, 0x2a, 0xfffffff5, 0xfffff800);
            case 20:
                return createExtendedFormat(1, 0x09, 0xfffffff5, 0xfffff800);
            // unused from this point down
            case 21:
                return createExtendedFormat(5, 0, 1, 0x800);
            case 22:
                return createExtendedFormat(6, 0, 1, 0x5c00);
            case 23:
                return createExtendedFormat(0, 0x31, 1, 0x5c00);
            case 24:
                return createExtendedFormat(0, 8, 1, 0x5c00);
            case 25:
                return createExtendedFormat(6, 8, 1, 0x5c00);
