...
package m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ddf;
...
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.hssf.usermodel.HSSFPictureData;
...
public final class EscherMetafileBlip extends EscherBlipRecord {
    ...
    private static byte[] inflatePictureData(byte[] data) {
        try (InflaterInputStream in = new InflaterInputStream(UnsynchronizedByteArrayInputStream.builder().setByteArray(data).get());
            ...
            Log.w(TAG, "Possibly corrupt compression or non-compressed data", e);
            return data;
        }
    }
    ...
    public void setBounds(Rect bounds) {
        field_3_rcBounds_x1 = bounds.left;
        field_3_rcBounds_y1 = bounds.top;
        field_3_rcBounds_x2 = bounds.left + bounds.width();
        field_3_rcBounds_y2 = bounds.top + bounds.height();
    }
    ...
    public short getSignature() {
        ...
        Log.w(TAG, String.format("Unknown metafile: %d", getRecordId()));
        return 0;
    }
