...
import m.co.rh.id.apoi_spreadsheet.org.apache.poi.ddf.EscherBitmapBlip;
import m.co.rh.id.apoi_spreadsheet.org.apache.poi.ddf.EscherBlipRecord;
import m.co.rh.id.apoi_spreadsheet.org.apache.poi.ddf.EscherMetafileBlip;
import m.co.rh.id.apoi_spreadsheet.org.apache.poi.ddf.EscherRecord;
import m.co.rh.id.apoi_spreadsheet.org.apache.poi.hpsf.ClassID;
import m.co.rh.id.apoi_spreadsheet.org.apache.poi.hpsf.ClassIDPredefined;
import m.co.rh.id.apoi_spreadsheet.org.apache.poi.hpsf.DocumentSummaryInformation;
import m.co.rh.id.apoi_spreadsheet.org.apache.poi.hpsf.SummaryInformation;
import m.co.rh.id.apoi_spreadsheet.org.apache.poi.hssf.OldExcelFormatException;
import m.co.rh.id.apoi_spreadsheet.org.apache.poi.hssf.model.DrawingManager2;
import m.co.rh.id.apoi_spreadsheet.org.apache.poi.hssf.model.HSSFFormulaParser;
import m.co.rh.id.apoi_spreadsheet.org.apache.poi.hssf.model.InternalSheet;
import m.co.rh.id.apoi_spreadsheet.org.apache.poi.hssf.model.InternalSheet.UnsupportedBOFType;
...
import m.co.rh.id.apoi_spreadsheet.org.apache.poi.poifs.crypt.ChunkedCipherOutputStream;
...
import m.co.rh.id.apoi_spreadsheet.org.apache.poi.poifs.filesystem.DocumentNode;
import m.co.rh.id.apoi_spreadsheet.org.apache.poi.poifs.filesystem.EntryUtils;
import m.co.rh.id.apoi_spreadsheet.org.apache.poi.poifs.filesystem.FileMagic;
import m.co.rh.id.apoi_spreadsheet.org.apache.poi.poifs.filesystem.FilteringDirectoryNode;
import m.co.rh.id.apoi_spreadsheet.org.apache.poi.poifs.filesystem.Ole10Native;
import m.co.rh.id.apoi_spreadsheet.org.apache.poi.poifs.filesystem.POIFSDocument;
...
import m.co.rh.id.apoi_spreadsheet.org.apache.poi.ss.formula.udf.IndexedUDFFinder;
...
import m.co.rh.id.apoi_spreadsheet.org.apache.poi.ss.util.WorkbookUtil;
...
public final class HSSFWorkbook extends POIDocument implements Workbook {
    ...
    private static final String LOGGER_TAG = "HSSFWorkbook";
    ...
    public HSSFWorkbook(DirectoryNode directory, boolean preserveNodes)
        ...
        while (rs.hasNext()) {
            try {
                ...
                Log.w(LOGGER_TAG, String.format("Unsupported BOF found of type %s", eb.getType()));
            }
        }
    ...
    private void convertLabelRecords(List<Record> records, int offset) {
        Log.d(LOGGER_TAG, "convertLabelRecords called");
        ...
        Log.d(LOGGER_TAG, "convertLabelRecords exit");
    }
...
//        workbook.cloneDrawings(clonedSheet.getSheet());
    ...
    public HSSFSheet createSheet(String sheetname) {
        ...
        if(sheetname.length() > MAX_SENSITIVE_SHEET_NAME_LEN) {
            ...
            Log.w(LOGGER_TAG, String.format("Sheet '%s' will be added with a trimmed name '%s' for MS Excel compliance.", sheetname, trimmedSheetname));
    ...
    public byte[] getBytes() {
        Log.d(LOGGER_TAG, "HSSFWorkbook.getBytes()");
