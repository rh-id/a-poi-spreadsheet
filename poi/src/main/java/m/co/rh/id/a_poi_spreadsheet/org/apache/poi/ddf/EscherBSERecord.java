...
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.sl.usermodel.PictureData;
...
public final class EscherBSERecord extends EscherRecord {
    ...
    public PictureData.PictureType getPictureTypeWin32() {
        return PictureData.PictureType.forNativeID(field_1_blipTypeWin32);
    }
    ...
    public PictureData.PictureType getPictureTypeMacOS() {
        return PictureData.PictureType.forNativeID(field_2_blipTypeMacOS);
    }
