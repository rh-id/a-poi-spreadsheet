...
public abstract class EscherRecord implements Duplicatable, GenericRecord {
     ...
     *
     * @see #fillFields(byte[], int, m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ddf.EscherRecordFactory)
     */
     ...
     * @return          The number of bytes written.
     *
     * @see #serialize(int, byte[], m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ddf.EscherSerializationListener)
     */
