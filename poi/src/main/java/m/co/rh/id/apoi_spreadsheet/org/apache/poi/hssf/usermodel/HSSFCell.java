...
import m.co.rh.id.apoi_spreadsheet.org.apache.poi.hssf.record.aggregates.FormulaRecordAggregate;
...
import m.co.rh.id.apoi_spreadsheet.org.apache.poi.ss.usermodel.CellBase;
...
public class HSSFCell extends CellBase {
     ...
     * @see m.co.rh.id.apoi_spreadsheet.org.apache.poi.hssf.usermodel.HSSFRow#createCell(int)
     */
     ...
     * @see m.co.rh.id.apoi_spreadsheet.org.apache.poi.hssf.usermodel.HSSFRow#createCell(int, CellType)
     */
    protected HSSFCell(HSSFWorkbook book, HSSFSheet sheet, int row, short col,
                       CellType type) {
        checkBounds(col);
     ...
     *
     * @see DateUtil
     * @see m.co.rh.id.apoi_spreadsheet.org.apache.poi.ss.usermodel.DateUtil
     */
    @Override
     ...
     * use {@link m.co.rh.id.apoi_spreadsheet.org.apache.poi.ss.util.CellUtil#setCellStyleProperties(m.co.rh.id.apoi_spreadsheet.org.apache.poi.ss.usermodel.Cell, java.util.Map)}</p>
     *
     * @param style reference contained in the workbook
     * @see m.co.rh.id.apoi_spreadsheet.org.apache.poi.hssf.usermodel.HSSFWorkbook#createCellStyle()
     * @see m.co.rh.id.apoi_spreadsheet.org.apache.poi.hssf.usermodel.HSSFWorkbook#getCellStyleAt(int)
     */
    @Override
