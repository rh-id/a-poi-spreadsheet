...
public interface Workbook extends Closeable, Iterable<Sheet> {
     ...
     * Set the sheet name.
     * <p>
     * See {@link m.co.rh.id.apoi_spreadsheet.org.apache.poi.ss.util.WorkbookUtil#createSafeSheetName(String nameProposal)}
     ...
     * @see m.co.rh.id.apoi_spreadsheet.org.apache.poi.ss.util.WorkbookUtil#createSafeSheetName(String nameProposal)
     */
