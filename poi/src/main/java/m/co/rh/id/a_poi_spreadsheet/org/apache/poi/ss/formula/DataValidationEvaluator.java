...
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.usermodel.DataValidationConstraint.OperatorType;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.usermodel.DataValidationConstraint.ValidationType;
...
public class DataValidationEvaluator {
    ...
    public static enum ValidationEnum {
        ...
        FORMULA {
             ...
             * @see m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.formula.DataValidationEvaluator.ValidationEnum#isValidValue(Cell, DataValidationContext)
             */
            public boolean isValidValue(Cell cell, DataValidationContext context) {
