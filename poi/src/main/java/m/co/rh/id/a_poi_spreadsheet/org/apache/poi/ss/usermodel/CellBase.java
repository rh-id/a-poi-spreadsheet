...
public abstract class CellBase implements Cell {
     ...
     * @see Row#removeCell(m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.usermodel.Cell)
     * @see m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.usermodel.Sheet#removeRow(m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.usermodel.Row)
     * @see m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.usermodel.Sheet#shiftRows(int, int, int)
     * @see m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.usermodel.Sheet#addMergedRegion(org.apache.poi.ss.util.CellRangeAddress)
