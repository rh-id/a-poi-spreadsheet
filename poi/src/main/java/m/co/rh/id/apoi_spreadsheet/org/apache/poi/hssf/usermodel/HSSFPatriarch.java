...
import m.co.rh.id.apoi_spreadsheet.org.apache.poi.ddf.EscherComplexProperty;
...
import m.co.rh.id.apoi_spreadsheet.org.apache.poi.ddf.EscherProperty;
...
import m.co.rh.id.apoi_spreadsheet.org.apache.poi.ddf.EscherSpgrRecord;
...
import m.co.rh.id.apoi_spreadsheet.org.apache.poi.hssf.record.EmbeddedObjectRefSubRecord;
...
import m.co.rh.id.apoi_spreadsheet.org.apache.poi.hssf.record.FtCfSubRecord;
import m.co.rh.id.apoi_spreadsheet.org.apache.poi.hssf.record.FtPioGrbitSubRecord;
...
public final class HSSFPatriarch implements HSSFShapeContainer, Drawing<HSSFShape> {
     ...
     *
     * @see m.co.rh.id.apoi_spreadsheet.org.apache.poi.hssf.usermodel.HSSFSheet#setAutoFilter(org.apache.poi.ss.util.CellRangeAddress)
     */
