...
import static m.co.rh.id.apoi_spreadsheet.org.apache.poi.hssf.record.common.ExtendedColor.TYPE_AUTO;
import static m.co.rh.id.apoi_spreadsheet.org.apache.poi.hssf.record.common.ExtendedColor.TYPE_INDEXED;
import static m.co.rh.id.apoi_spreadsheet.org.apache.poi.hssf.record.common.ExtendedColor.TYPE_RGB;
import static m.co.rh.id.apoi_spreadsheet.org.apache.poi.hssf.record.common.ExtendedColor.TYPE_THEMED;
...
public class HSSFExtendedColor extends ExtendedColor {
    private m.co.rh.id.apoi_spreadsheet.org.apache.poi.hssf.record.common.ExtendedColor color;

    public HSSFExtendedColor(m.co.rh.id.apoi_spreadsheet.org.apache.poi.hssf.record.common.ExtendedColor color) {
        this.color = color;
    }

    protected m.co.rh.id.apoi_spreadsheet.org.apache.poi.hssf.record.common.ExtendedColor getExtendedColor() {
        return color;
    }
