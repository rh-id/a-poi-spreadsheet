...
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.format.SimpleFraction;
...
public class FractionFormat extends Format {
    private static final String TAG = "FractionFormat";
    ...
    private String format(final BigDecimal decimal) {
        ...
        try {
            ...
            Log.w(TAG, "Can't format fraction", e);
