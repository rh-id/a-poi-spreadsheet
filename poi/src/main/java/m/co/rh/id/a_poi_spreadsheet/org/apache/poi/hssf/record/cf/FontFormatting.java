...
package m.co.rh.id.a_poi_spreadsheet.org.apache.poi.hssf.record.cf;

import static m.co.rh.id.a_poi_spreadsheet.org.apache.poi.util.GenericRecordUtil.getBitsAsString;
import static m.co.rh.id.a_poi_spreadsheet.org.apache.poi.util.GenericRecordUtil.getEnumBitsAsString;
...
public final class FontFormatting implements Duplicatable, GenericRecord {
     ...
     * @see #setFontOption(boolean, m.co.rh.id.a_poi_spreadsheet.org.apache.poi.util.BitField)
     */
     ...
     * @see #getFontOption(m.co.rh.id.a_poi_spreadsheet.org.apache.poi.util.BitField)
     */
