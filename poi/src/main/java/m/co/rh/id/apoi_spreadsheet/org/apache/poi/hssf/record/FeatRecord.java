...
import m.co.rh.id.apoi_spreadsheet.org.apache.poi.hssf.record.common.FeatFormulaErr2;
import m.co.rh.id.apoi_spreadsheet.org.apache.poi.hssf.record.common.FeatProtection;
import m.co.rh.id.apoi_spreadsheet.org.apache.poi.hssf.record.common.FeatSmartTag;
import m.co.rh.id.apoi_spreadsheet.org.apache.poi.hssf.record.common.FtrHeader;
import m.co.rh.id.apoi_spreadsheet.org.apache.poi.hssf.record.common.SharedFeature;
...
public final class FeatRecord extends StandardRecord {
    ...
    public FeatRecord(RecordInputStream in) {
        ...
        case FeatHdrRecord.SHAREDFEATURES_ISFFACTOID:
            ...
            break;
        default:
            Log.e(TAG, String.format("Unknown Shared Feature %s found!", isf_sharedFeatureType));
        }
    }
