...
import static m.co.rh.id.a_poi_spreadsheet.org.apache.poi.poifs.crypt.dsig.facets.XAdESSignatureFacet.insertXChild;
...
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.poifs.crypt.dsig.services.RevocationData;
...
public class XAdESXLSignatureFacet implements SignatureFacet {
    ...
    private static final String TAG = "XAdESXLSignatureFacet";
    ...
    public void postSign(SignatureInfo signatureInfo, Document document) throws MarshalException {
        Log.d(TAG, "XAdES-X-L post sign phase");
        ...
        Log.d(TAG, "creating XAdES-T time-stamp");
        ...
        if (revDataSvc != null) {
            ...
            Log.d(TAG, "creating XAdES-X time-stamp");
