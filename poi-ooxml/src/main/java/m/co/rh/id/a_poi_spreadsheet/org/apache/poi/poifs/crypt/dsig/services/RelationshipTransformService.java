...
import static m.co.rh.id.a_poi_spreadsheet.org.apache.poi.poifs.crypt.dsig.facets.SignatureFacet.XML_NS;
...
public class RelationshipTransformService extends TransformService {
    ...
    private static final String TAG = "RelationshipTransformService";
    ...
    public void init(XMLStructure parent, XMLCryptoContext context) throws InvalidAlgorithmParameterException {
        Log.d(TAG, "init(parent,context)");
        Log.d(TAG, String.format("parent java type: %s", parent.getClass().getName()));
    ...
    public Data transform(Data data, XMLCryptoContext context) throws TransformException {
        Log.d(TAG, "transform(data,context)");
        Log.d(TAG, String.format("data java type: %s", data.getClass().getName()));
        OctetStreamData octetStreamData = (OctetStreamData) data;
        Log.d(TAG, String.format("URI: %s", octetStreamData.getURI()));
        ...
        Log.d(TAG, String.format("# Relationship elements: %d", rsList.size()));

        return new ApacheNodeSetData(new XMLSignatureInput(root));
    }

    public Data transform(Data data, XMLCryptoContext context, OutputStream os) throws TransformException {
        Log.d(TAG, "transform(data,context,os)");
        return null;
    }
