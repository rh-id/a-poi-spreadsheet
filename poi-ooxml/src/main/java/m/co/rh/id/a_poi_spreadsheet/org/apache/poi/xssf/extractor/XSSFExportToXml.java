...
public class XSSFExportToXml implements Comparator<String> {
    ...
    private static void trySet(String name, SecurityFeature securityFeature) {
        try {
            ...
            Log.w(TAG, String.format("SchemaFactory feature (%s) unsupported", name), e);
        } catch (AbstractMethodError ame) {
            Log.w(TAG, String.format("Cannot set SchemaFactory feature (%s) because outdated XML parser in classpath", name), ame);
        }
    }
}
