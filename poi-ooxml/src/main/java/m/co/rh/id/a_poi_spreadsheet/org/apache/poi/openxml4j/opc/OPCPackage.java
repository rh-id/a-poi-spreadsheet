...
package m.co.rh.id.a_poi_spreadsheet.org.apache.poi.openxml4j.opc;

import static m.co.rh.id.a_poi_spreadsheet.org.apache.poi.openxml4j.opc.ContentTypes.EXTENSION_XML;
import static m.co.rh.id.a_poi_spreadsheet.org.apache.poi.openxml4j.opc.ContentTypes.PLAIN_OLD_XML;
import static m.co.rh.id.a_poi_spreadsheet.org.apache.poi.openxml4j.opc.ContentTypes.RELATIONSHIPS_PART;
import static m.co.rh.id.a_poi_spreadsheet.org.apache.poi.openxml4j.opc.PackagingURIHelper.RELATIONSHIP_PART_EXTENSION_NAME;
...
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.openxml4j.exceptions.InvalidOperationException;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.openxml4j.exceptions.OpenXML4JRuntimeException;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.openxml4j.exceptions.PartAlreadyExistsException;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.openxml4j.opc.internal.ContentType;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.openxml4j.opc.internal.ContentTypeManager;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.openxml4j.opc.internal.PackagePropertiesPart;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.openxml4j.opc.internal.PartMarshaller;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.openxml4j.opc.internal.PartUnmarshaller;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.openxml4j.opc.internal.ZipContentTypeManager;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.openxml4j.opc.internal.marshallers.DefaultMarshaller;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.openxml4j.opc.internal.marshallers.ZipPackagePropertiesMarshaller;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.openxml4j.opc.internal.unmarshallers.PackagePropertiesUnmarshaller;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.openxml4j.opc.internal.unmarshallers.UnmarshallContext;
...
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.util.NotImplemented;
...
public abstract class OPCPackage implements RelationshipSource, Closeable {
     ...
     * Logger.
     */
    private static final String TAG = "OPCPackage";
     ...
     * of native methods
     *
     * @param in The InputStream to read the package from. The stream is closed.
    ...
    public void close() throws IOException {
        ...
        if (this.packageAccess == PackageAccess.READ) {
            Log.d(TAG, "The close() method is intended to SAVE a package. This package is open in READ ONLY mode, use the revert() method instead!");
            revert();
            return;
        }
        if (this.contentTypeManager == null) {
            Log.w(TAG, "Unable to call close() on a package that hasn't been fully opened yet");
            revert();
            return;
        }
     ...
     *
     * @param relationshipType Relationship type. Must not be {@code null}.
            ...
            for (PackagePart part : new ArrayList<>(partList.sortedValues())) {
                ...
                if (ContentTypes.CORE_PROPERTIES_PART.equals(part.getContentType())) {
                    if (!hasCorePropertiesPart) {
                        ...
                        Log.w(TAG, "OPC Compliance error [M4.1]: " +
                ...
                if (partUnmarshaller != null) {
                    ...
                    try (InputStream partStream = part.getInputStream()) {
                        ...
                        Log.w(TAG, String.format("Unmarshall operation : IOException for %s", part._partName));
     ...
     * @throws InvalidOperationException If rule M1.12 is not verified : Packages shall not contain
     *                                   equivalent part names and package implementers shall neither
     *                                   create nor recognize packages with equivalent part names.
     */
     ...
     *
     * @param part The part to remove. If {@code null}, skip the action.
    ...
    public void removePart(PackagePartName partName) {
        ...
        if (partName.isRelationshipPartURI()) {
            ...
            try {
                ...
                Log.e(TAG, String.format("Part name URI '%s' is not valid! This message is not intended to be displayed!", sourceURI));
                return;
            }
    ...
    public void deletePartRecursive(PackagePartName partName) {
        ...
        try {
            ...
            Log.w(String.format("An exception occurs while deleting part '%s'. Some parts may remain in the package.", partName.getName()), e);
            return;
        }
        // Remove the relationships part
    ...
    public void addMarshaller(String contentType, PartMarshaller marshaller) {
        try {
            ...
            Log.w(TAG, String.format("The specified content type is not valid: '%s'. The marshaller will not be added !", e.getMessage()));
        }
    }
    ...
    public void addUnmarshaller(String contentType,
        ...
        try {
            ...
            Log.w(TAG, String.format("The specified content type is not valid: '%s'. The unmarshaller will not be added !", e.getMessage()));
        }
    }
     ...
     *
     * @param nameTemplate The template for new part names containing a {@code '#'} for the index,
