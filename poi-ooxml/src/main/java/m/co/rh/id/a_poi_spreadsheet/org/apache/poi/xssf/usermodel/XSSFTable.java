...
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.usermodel.TableStyleInfo;
...
public class XSSFTable extends POIXMLDocumentPart implements Table {
    ...
    private static final String TAG = "XSSFTable";
        ...
        if (newStyleName == null) {
            if (ctTable.isSetTableStyleInfo()) {
                try {
                    ...
                    Log.d(TAG, "Failed to unset style name", e);
                }
            }
            styleName = null;
            return;
    ...
    /**
     * @see m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.usermodel.Table#contains(m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.usermodel.Cell)
     * @since 3.17 beta 1
     */
    @Override
