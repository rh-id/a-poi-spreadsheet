...
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.formula.SharedFormula;
...
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.usermodel.CellCopyContext;
...
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.util.CellUtil;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.util.Beta;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.util.ExceptionUtil;
...
public final class XSSFCell extends CellBase {
     ...
     *
     * This does not shift references in formulas. Use {@link m.co.rh.id.a_poi_spreadsheet.org.apache.poi.xssf.usermodel.helpers.XSSFRowShifter} to shift references in formulas.
     *
     ...
     * @throws m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.formula.FormulaParseException if the formula has incorrect syntax or is otherwise invalid
     ...
     * use {@link m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.util.CellUtil#setCellStyleProperties(Cell, java.util.Map)}</p>
     *
