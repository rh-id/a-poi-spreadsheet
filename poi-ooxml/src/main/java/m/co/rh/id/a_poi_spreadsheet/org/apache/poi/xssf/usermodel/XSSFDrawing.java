...
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.util.ImageUtils;
...
public final class XSSFDrawing extends POIXMLDocumentPart implements Drawing<XSSFShape> {
    private static final String TAG = "XSSFDrawing";
            ...
            if (cur.toFirstChild()) {
                do {
                    ...
                    if (obj instanceof CTMarker) {
                        ...
                        Log.w(TAG, "trying to parse AlternateContent, this unlinks the returned Shapes from the underlying xml content, so those shapes can't be used to modify the drawing, i.e. modifications will be ignored!");
                        ...
                        try {
                            ...
                            Log.w(TAG, "unable to parse CTDrawing in alternate content.", e);
                        } finally {
                            cur.pop();
                        }
                        continue;
