...
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ooxml.util.XPathHelper;
...
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.xssf.usermodel.XSSFCell;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.xssf.usermodel.XSSFMap;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.xssf.usermodel.XSSFRow;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.xssf.usermodel.XSSFTable;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.xssf.usermodel.XSSFTableColumn;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.xssf.usermodel.helpers.XSSFSingleXmlCell;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.xssf.usermodel.helpers.XSSFXmlColumnPr;
...
public class XSSFImportFromXML {
    ...
    private static final String TAG = "XSSFImportFromXML";
        ...
        for (XSSFTable table : tables) {
            ...
            for (int i = 0; i < result.getLength(); i++) {
                ...
                for (XSSFTableColumn tableColumn : table.getColumns()) {
                    ...
                    Log.d(TAG, String.format("Extracting with xpath %s : value is '%s'", localXPath, value));
