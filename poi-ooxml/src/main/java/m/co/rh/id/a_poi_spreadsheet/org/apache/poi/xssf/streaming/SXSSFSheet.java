...
package m.co.rh.id.a_poi_spreadsheet.org.apache.poi.xssf.streaming;
...
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.usermodel.AutoFilter;
...
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.usermodel.PrintSetup;
...
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.usermodel.SheetConditionalFormatting;
...
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.xssf.usermodel.OoxmlSheetExtensions;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.xssf.usermodel.XSSFColor;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.xssf.usermodel.XSSFComment;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.xssf.usermodel.XSSFDataValidation;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.xssf.usermodel.XSSFDrawing;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.xssf.usermodel.XSSFHyperlink;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.xssf.usermodel.XSSFSheet;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.xssf.usermodel.XSSFVMLDrawing;

/**
 * Streaming version of XSSFSheet implementing the "BigGridDemo" strategy.
 */
public class SXSSFSheet implements Sheet, OoxmlSheetExtensions {
    private static final String TAG = "SXSSFSheet";
    ...
    protected SXSSFSheet(SXSSFWorkbook workbook, XSSFSheet xSheet, int randomAccessWindowSize) {
        ...
        try {
            ...
            Log.w(TAG, "Failed to create AutoSizeColumnTracker, possibly due to fonts not being installed in your OS", e);
        }
    }
...
//    public CellStyle setColumnStyle(int column, CellStyle style);
     ...
     * Calculating the formula values with {@link m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.usermodel.FormulaEvaluator} is the
    ...
    void deriveDimension() {
        if (_workbook.shouldCalculateSheetDimensions()) {
            try {
                ...
                Log.d(TAG, "Failed to set dimension details on sheet", e);
            }
        }
    }
}
