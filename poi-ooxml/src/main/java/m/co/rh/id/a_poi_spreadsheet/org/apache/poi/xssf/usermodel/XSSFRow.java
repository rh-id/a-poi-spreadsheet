...
public class XSSFRow implements Row, Comparable<XSSFRow> {
     ...
     *  with the {@link m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.usermodel.Row.MissingCellPolicy} from the parent Workbook.
     *
    ...
    /**
     * Returns the cell at the given (0 based) index, with the specified {@link m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.usermodel.Row.MissingCellPolicy}
     *
     * @return the cell at the given (0 based) index
     ...
     * See {@link m.co.rh.id.a_poi_spreadsheet.org.apache.poi.xssf.usermodel.XSSFSheet#getDefaultRowHeightInPoints()}
     *
     ...
     * @see m.co.rh.id.a_poi_spreadsheet.org.apache.poi.xssf.usermodel.XSSFSheet#getDefaultRowHeightInPoints()
     */
    @Override
     ...
     *
     * @see m.co.rh.id.a_poi_spreadsheet.org.apache.poi.xssf.usermodel.XSSFSheet#write(java.io.OutputStream) ()
     */
