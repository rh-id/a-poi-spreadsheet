...
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.usermodel.FontFormatting;
...
public class XSSFFontFormatting implements FontFormatting {
    ...
    public short getEscapementType(){
        if(_font.sizeOfVertAlignArray() == 0) return Font.SS_NONE;
    ...
    public void setEscapementType(short escapementType){
        ...
        if(escapementType != Font.SS_NONE){
     ...
     *
     * @see m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.usermodel.FontFormatting#isStruckout()
     */
    @Override
