...
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ooxml.POIXMLRelation.PackagePartConstructor;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ooxml.POIXMLRelation.ParentPartConstructor;
...
public abstract class POIXMLFactory {
    private static final String TAG = "POIXMLFactory";
    ...
    public POIXMLDocumentPart createDocumentPart(POIXMLDocumentPart parent, PackagePart part) {
        ...
        try {
            ...
            Log.d(TAG, String.format("using default POIXMLDocumentPart for %s", rel.getRelationshipType()));
