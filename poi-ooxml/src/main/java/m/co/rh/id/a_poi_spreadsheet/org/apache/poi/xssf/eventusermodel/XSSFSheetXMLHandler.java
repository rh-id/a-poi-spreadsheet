...
import static m.co.rh.id.a_poi_spreadsheet.org.apache.poi.xssf.usermodel.XSSFRelation.NS_SPREADSHEETML;
...
public class XSSFSheetXMLHandler extends DefaultHandler {
    private static final String TAG = "XSSFSheetXMLHandler";
            ...
            if (type != null && type.equals("shared")) {
                ...
                if (ref != null) {
                    ...
                    if (formulasNotResults) {
                        Log.w(TAG, "shared formulas not yet supported!");
                    } /*else {
                ...
                case SST_STRING:
                    ...
                    if (sstIndex.length() > 0) {
                        try {
                            ...
                            Log.e(TAG, String.format("Failed to parse SST index '%s'", sstIndex), ex);
                        }
                    }
                    break;
