...
public abstract class PackagePart implements RelationshipSource, Comparable<PackagePart> {
     ...
     * @return The newly created and added relationship
     * @see m.co.rh.id.apoi_spreadsheet.org.apache.poi.openxml4j.opc.RelationshipSource#addExternalRelationship(String,
     * String)
     */
    @Override
    public PackageRelationship addExternalRelationship(String target,
     ...
     * @param relationshipType Type of relationship.
     * @return The newly created and added relationship
     * @see m.co.rh.id.apoi_spreadsheet.org.apache.poi.openxml4j.opc.RelationshipSource#addRelationship(m.co.rh.id.apoi_spreadsheet.org.apache.poi.openxml4j.opc.PackagePartName,
     * m.co.rh.id.apoi_spreadsheet.org.apache.poi.openxml4j.opc.TargetMode, String)
     */
     ...
     * @see m.co.rh.id.apoi_spreadsheet.org.apache.poi.openxml4j.opc.RelationshipSource#addRelationship(m.co.rh.id.apoi_spreadsheet.org.apache.poi.openxml4j.opc.PackagePartName,
     * m.co.rh.id.apoi_spreadsheet.org.apache.poi.openxml4j.opc.TargetMode, String, String)
     */
    public PackageRelationship addRelationship(URI targetURI,
                                               TargetMode targetMode, String relationshipType, String id) {
        _container.throwExceptionIfReadOnly();
     ...
     * @see m.co.rh.id.apoi_spreadsheet.org.apache.poi.openxml4j.opc.internal.MemoryPackagePart
     */
