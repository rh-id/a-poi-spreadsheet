...
public class TimeStampSimpleHttpClient implements TimeStampHttpClient {
    ...
    private static final String TAG = "TimeStampSimpleHttpClient";
            ...
            switch (responseCode) {
                ...
                case HttpURLConnection.HTTP_SEE_OTHER:
                    ...
                    if (newUrl != null && followRedirect) {
                        Log.w(TAG, String.format("Received redirect: %s -> %s", url, newUrl));
                        return handleRedirect(newUrl, handler, false);
                    }

                    Log.w(TAG, String.format("Redirect ignored - giving up: %s -> %s", url, newUrl));
                    responseBytes = null;
                    break;
