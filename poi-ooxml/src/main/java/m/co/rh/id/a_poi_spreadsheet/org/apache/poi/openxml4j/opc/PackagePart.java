...
public abstract class PackagePart implements RelationshipSource, Comparable<PackagePart> {
     ...
     * @return The newly created and added relationship
     * @see m.co.rh.id.a_poi_spreadsheet.org.apache.poi.openxml4j.opc.RelationshipSource#addExternalRelationship(String,
     * String)
     */
    @Override
    public PackageRelationship addExternalRelationship(String target,
     ...
     * @param relationshipType Type of relationship.
     * @return The newly created and added relationship
     * @see m.co.rh.id.a_poi_spreadsheet.org.apache.poi.openxml4j.opc.RelationshipSource#addRelationship(m.co.rh.id.a_poi_spreadsheet.org.apache.poi.openxml4j.opc.PackagePartName,
     * m.co.rh.id.a_poi_spreadsheet.org.apache.poi.openxml4j.opc.TargetMode, String)
     */
     ...
     * @param id               Relationship unique id.
     * @return The newly created and added relationship
     * @throws InvalidOperationException If the URI point to a relationship part URI.
     * @see m.co.rh.id.a_poi_spreadsheet.org.apache.poi.openxml4j.opc.RelationshipSource#addRelationship(m.co.rh.id.a_poi_spreadsheet.org.apache.poi.openxml4j.opc.PackagePartName,
     * m.co.rh.id.a_poi_spreadsheet.org.apache.poi.openxml4j.opc.TargetMode, String, String)
     */
    public PackageRelationship addRelationship(URI targetURI,
                                               TargetMode targetMode, String relationshipType, String id) {
        _container.throwExceptionIfReadOnly();
     ...
     * @see m.co.rh.id.a_poi_spreadsheet.org.apache.poi.openxml4j.opc.internal.MemoryPackagePart
     */
     ...
     * @throws IOException Throws if an IO Exception occur in the implementation method.
     */
