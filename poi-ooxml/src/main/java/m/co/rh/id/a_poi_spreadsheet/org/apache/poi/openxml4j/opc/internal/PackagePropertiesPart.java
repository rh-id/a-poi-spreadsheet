...
public final class PackagePropertiesPart extends PackagePart implements PackageProperties {
     ...
     *
     * @see PackageProperties#setCreatedProperty(Optional)
     */
    @Override
     ...
     *
     * @see PackageProperties#setLastPrintedProperty(Optional)
     */
    @Override
     ...
     *
     * @see PackageProperties#setModifiedProperty(Optional)
     */
    @Override
