...
import m.co.rh.id.apoi_spreadsheet.org.apache.poi.ooxml.POIXMLRelation.PackagePartConstructor;
import m.co.rh.id.apoi_spreadsheet.org.apache.poi.ooxml.POIXMLRelation.ParentPartConstructor;
...
public abstract class POIXMLFactory {
    private static final String LOGGER_TAG = "POIXMLFactory";
    ...
    public POIXMLDocumentPart createDocumentPart(POIXMLDocumentPart parent, PackagePart part) {
        ...
        try {
            ...
            Log.d(LOGGER_TAG, String.format("using default POIXMLDocumentPart for %s", rel.getRelationshipType()));
