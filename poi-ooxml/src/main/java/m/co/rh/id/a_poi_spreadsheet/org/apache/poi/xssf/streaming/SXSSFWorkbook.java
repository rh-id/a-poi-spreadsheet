...
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.formula.EvaluationWorkbook;
...
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.usermodel.CreationHelper;
...
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.usermodel.PictureData;
...
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.xssf.usermodel.XSSFChartSheet;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.xssf.usermodel.XSSFSheet;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.xssf.usermodel.XSSFWorkbook;
...
public class SXSSFWorkbook implements Workbook {
    ...
    private static final String TAG = "SXSSFWorkbook";
    ...
    public void close() throws IOException {
        ...
        for (SXSSFSheet sheet : _xFromSxHash.values()) {
            try {
                ...
                Log.w(TAG, String.format("An exception occurred while closing sheet data writer for sheet %s.", sheet.getSheetName()), e);
            }
        }
    ...
    public boolean dispose() {
        ...
        for (SXSSFSheet sheet : _sxFromXHash.keySet()) {
            try {
                ...
                Log.w(TAG, "Failed to dispose sheet", e);
                success = false;
            }
        }
        return success;
