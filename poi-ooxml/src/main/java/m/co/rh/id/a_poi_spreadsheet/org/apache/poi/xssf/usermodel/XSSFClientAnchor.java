...
//        this.cell2 = calcCell(sheet, cell1, size.getCx(), size.getCy());
    ...
    /**
     * @throws NullPointerException if cell1 is null (fixed position)
     * @see m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.usermodel.ChildAnchor#setDx1(int)
     */
    @Override
    ...
    /**
     * @throws NullPointerException if cell1 is null (fixed position)
     * @see m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.usermodel.ChildAnchor#setDy1(int)
     */
    @Override
    ...
    /**
     * @throws NullPointerException if cell2 is null (fixed size)
     * @see m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.usermodel.ChildAnchor#setDy2(int)
     */
    @Override
    ...
    /**
     * @throws NullPointerException if cell2 is null (fixed size)
     * @see m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.usermodel.ChildAnchor#setDx2(int)
     */
    @Override
