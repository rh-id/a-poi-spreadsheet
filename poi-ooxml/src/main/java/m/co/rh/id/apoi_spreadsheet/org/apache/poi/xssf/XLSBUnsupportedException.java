...
import m.co.rh.id.apoi_spreadsheet.org.apache.poi.UnsupportedFileFormatException;

/**
 * We don't support .xlsb for read and write via {@link m.co.rh.id.apoi_spreadsheet.org.apache.poi.xssf.usermodel.XSSFWorkbook}.
 * As of POI 3.16-beta3, we do support streaming reading of xlsb files
 * via {@link m.co.rh.id.apoi_spreadsheet.org.apache.poi.xssf.eventusermodel.XSSFBReader}
 */
