...
package m.co.rh.id.a_poi_spreadsheet.org.apache.poi.poifs.crypt.dsig.facets;

import static m.co.rh.id.a_poi_spreadsheet.org.apache.poi.poifs.crypt.dsig.facets.SignatureFacetHelper.newReference;
import static m.co.rh.id.a_poi_spreadsheet.org.apache.poi.poifs.crypt.dsig.facets.SignatureFacetHelper.newTransform;
...
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.poifs.crypt.dsig.SignatureConfig;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.poifs.crypt.dsig.SignatureInfo;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.poifs.crypt.dsig.services.RelationshipTransformService;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.poifs.crypt.dsig.services.RelationshipTransformService.RelationshipTransformParameterSpec;
...
public class OOXMLSignatureFacet implements SignatureFacet {
    ...
    private static final String TAG = "OOXMLSignatureFacet";
        ...
        for (PackagePart pp : relsEntryNames) {
            ...
            for (PackageRelationship relationship : prc) {
                ...
                if (relationshipType.endsWith("customXml")
                    ...
                    Log.d(TAG, String.format("skipping customXml with content type: %s", contentType));
                    continue;
                }
    ...
    private static String normalizePartName(URI partName, String baseUri) throws XMLSignatureException {
        ...
        try {
            ...
            Log.d(TAG, String.format("part name: %s", pn));
    ...
    protected void addSignatureTime(SignatureInfo signatureInfo, Document document, List<XMLStructure> objectContent) {
        ...
        Log.d(TAG, String.format("execution time: %s", ctTime.getValue()));
    ...
    protected static boolean isSignedRelationship(String relationshipType) {
        Log.d(TAG, String.format("relationship type: %s", relationshipType));
