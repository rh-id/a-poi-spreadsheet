...
import m.co.rh.id.apoi_spreadsheet.org.apache.poi.ss.usermodel.BaseTestNamedRange;
...
public final class TestXSSFName extends BaseTestNamedRange {
    ...
    public void testSetNameNameCellAddress() throws IOException {
        ...
        for (String ref : Arrays.asList("A1", "$A$1", "A1:B2")) {
            assertThrows("cell addresses are not allowed: " + ref,
                    IllegalArgumentException.class, () -> name.setNameName(ref));
        }
