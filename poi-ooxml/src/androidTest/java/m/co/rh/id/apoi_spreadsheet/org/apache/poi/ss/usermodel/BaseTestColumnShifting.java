...
import m.co.rh.id.apoi_spreadsheet.org.apache.poi.ss.usermodel.helpers.ColumnShifter;
...
public abstract class BaseTestColumnShifting {
    ...
    public void testShiftLeft() {
        assertThrows("Shift to negative indices should throw exception",
                IllegalStateException.class, () -> columnShifter.shiftColumns(1, 2, -3));
    }
}
