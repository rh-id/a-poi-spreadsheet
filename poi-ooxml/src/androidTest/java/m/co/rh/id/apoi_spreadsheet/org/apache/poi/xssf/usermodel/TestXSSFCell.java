...
public final class TestXSSFCell extends BaseTestXCell {
        ...
        for (Row r : sheetRef) {
            ...
            for (Cell c : rowRef) {
                ...
                if (!cell.getCTCell().isSetR()) {
                    assertTrue("R must e set in cellRef",
                            cellRef.getCTCell().isSetR());
    ...
    public void testBug56644ReturnNull() throws IOException {
        for (MissingCellPolicy policy : MissingCellPolicy.values()) {
    ...
    @Test
    public void testCopyCellFrom_CellCopyPolicy_copyHyperlink() throws IOException {
        setUp_testCopyCellFrom_CellCopyPolicy();
        ...
        assertEquals("number of hyperlinks on sheet",
                2, links.size());
    ...
    @Test
    public void testCopyCellFrom_CellCopyPolicy_mergeHyperlink() throws IOException {
        setUp_testCopyCellFrom_CellCopyPolicy();
        final Workbook wb = srcCell.getSheet().getWorkbook();
        final CreationHelper createHelper = wb.getCreationHelper();
