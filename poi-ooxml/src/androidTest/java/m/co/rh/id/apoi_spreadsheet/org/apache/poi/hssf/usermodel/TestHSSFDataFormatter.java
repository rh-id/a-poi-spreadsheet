...
public final class TestHSSFDataFormatter {
    ...
    public void testGetFormattedCellValueHSSFCell() {
        ...
        while (it.hasNext()) {
            ...
            assertTrue("Format came out incorrect - " + fmt + " - found " + fmtval + ", but expected to find '11:23'",
                    fmtval.contains("11:23"));
        }
    ...
    public void testSetDefaultNumberFormat() {
        ...
        while (it.hasNext()) {
            ...
            assertTrue("Doesn't start with Balance: " + formatted,
                    formatted.startsWith("Balance "));
            assertTrue("Doesn't end with USD: " + formatted,
