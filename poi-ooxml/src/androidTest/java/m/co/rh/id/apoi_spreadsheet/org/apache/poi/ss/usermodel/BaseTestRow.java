 ...
 * {@link m.co.rh.id.apoi_spreadsheet.org.apache.poi.ss.usermodel.Row}
 */
public abstract class BaseTestRow {
    ...
    public void testLastCellNumIsCorrectAfterAddCell_bug43901() throws IOException {
        ...
        assertEquals(-1, row.getLastCellNum());
        assertNotEquals("Identified bug 43901",
    ...
    public void testCellShiftingRight() {
        ...
        assertThrows("range [6-4] is illegal",
                IllegalArgumentException.class, () -> row.shiftCellsLeft(6, 4, 2));
    ...
    public void testCellShiftingLeft() {
        ...
        assertThrows("step = -1 is illegal",
                IllegalArgumentException.class, () -> row.shiftCellsLeft(4, 6, -2));
