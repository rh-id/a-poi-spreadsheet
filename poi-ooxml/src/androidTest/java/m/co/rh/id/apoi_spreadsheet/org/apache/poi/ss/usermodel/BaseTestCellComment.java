...
public abstract class BaseTestCellComment {
    ...
    public final void readComments() throws IOException {
        ...
        for (int rownum = 0; rownum < 3; rownum++) {
            ...
            cell = row.getCell(0);
            comment = cell.getCellComment();
            assertNull("Cells in the first column are not commented",
                    comment);
    ...
    public void attemptToSave2CommentsWithSameCoordinates() throws IOException {
        try (Workbook wb = _testDataProvider.createWorkbook()) {
            ...
            RuntimeException e = assertThrows("Should not be able to create a corrupted workbook with multiple cell comments in one cell",
