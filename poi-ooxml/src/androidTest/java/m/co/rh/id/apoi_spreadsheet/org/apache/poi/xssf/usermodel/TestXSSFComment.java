...
import m.co.rh.id.apoi_spreadsheet.org.apache.poi.ss.usermodel.BaseTestCellComment;
...
public final class TestXSSFComment extends BaseTestCellComment {
    ...
    @Test
    public void bug59388CommentVisible() throws IOException {
    ...
    @Test
    public void testMoveCommentSXSSF() throws Exception {
    ...
    @Test
    public void testMoveCommentCopySXSSF() throws Exception {
        SXSSFWorkbook workbook = new SXSSFWorkbook();
        try {
    ...
    @Test
    public void testMoveCommentIsSaved() throws Exception {
        _testMoveIsSaved(new XSSFWorkbook());
    }

    @Test
    public void testMoveCommentIsSavedSXSSF() throws Exception {
        SXSSFWorkbook workbook = new SXSSFWorkbook();
        try {
    ...
    @Test
    public void testModifiedCommentIsSaved() throws Exception {
        _testModificationIsSaved(new XSSFWorkbook());
    }

    @Test
    public void testModifiedCommentIsSavedSXSSF() throws Exception {
        SXSSFWorkbook workbook = new SXSSFWorkbook();
        try {
    ...
    private void _testMove(Workbook workbook) throws Exception {
        ...
        try {
            ...
            assertNull("no longer a comment on cell A1?",
                    commentsTable.findCellComment(new CellAddress("A1")));
    ...
    private void _testMoveIsSaved(Workbook workbook) throws Exception {
        try (UnsynchronizedByteArrayOutputStream bos = UnsynchronizedByteArrayOutputStream.builder().get()) {
            ...
            assertEquals(comment.getString().getString(), comment2.getString().getString());
            assertNull("comment still found on A1?",
                    sheet.getCellComment(new CellAddress("A1")));
