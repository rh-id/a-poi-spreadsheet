...
import m.co.rh.id.apoi_spreadsheet.org.apache.poi.ss.formula.eval.NotImplementedFunctionException;
...
public abstract class BaseTestExternalFunctions {
    ...
    public void testExternalFunctions() throws IOException {
        try (Workbook wb = _testDataProvider.createWorkbook()) {
            ...
            NotImplementedException e = assertThrows("Expected NotImplementedFunctionException/NotImplementedException",
                    NotImplementedException.class, () -> evaluator.evaluate(cell2));
