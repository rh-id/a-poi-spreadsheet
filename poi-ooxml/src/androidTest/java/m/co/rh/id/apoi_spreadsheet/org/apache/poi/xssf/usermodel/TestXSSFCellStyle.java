...
import m.co.rh.id.apoi_spreadsheet.org.apache.poi.hssf.usermodel.HSSFCellStyle;
...
public class TestXSSFCellStyle {
    ...
    public void testGetSetBottomBorderColor() {
        ...
        //setting XSSFColor
        num = stylesTable.getBorders().size();
        Color color = Color.valueOf(Color.CYAN);
        clr = new XSSFColor(color, stylesTable.getIndexedColors());
        ...
        int cargb = color.toArgb();
        assertEquals(Color.rgb(Color.red(cargb), Color.green(cargb), Color.blue(cargb)),
                Color.rgb(rgb[0] & 0xFF, rgb[1] & 0xFF, rgb[2] & 0xFF));
    ...
    @Test
    public void cloneToHSSF() throws IOException {
        try (
    ...
    @Test
    public void cloneFromHSSF() throws IOException {
        try (
                XSSFWorkbook xssfWorkbook = new XSSFWorkbook();
                HSSFWorkbook hssfWorkbook = new HSSFWorkbook()
        ) {
    ...
    @Test
    public void cachedPropertiesInvalidation() throws IOException {
