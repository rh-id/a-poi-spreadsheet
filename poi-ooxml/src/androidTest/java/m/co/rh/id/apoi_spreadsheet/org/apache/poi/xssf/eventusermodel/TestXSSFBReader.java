...
import m.co.rh.id.apoi_spreadsheet.org.apache.poi.xssf.binary.XSSFBSharedStringsTable;
import m.co.rh.id.apoi_spreadsheet.org.apache.poi.xssf.binary.XSSFBSheetHandler;
import m.co.rh.id.apoi_spreadsheet.org.apache.poi.xssf.binary.XSSFBStylesTable;
...
//        assertNotNull(r.getWorkbookData());
    ...
    @Test
    public void testBasicXSSFBSheetContentsHandler() throws Exception {
    ...
    @Test
    public void testCommentsXSSFBSheetContentsHandler() throws Exception {
        XSSFBSheetHandler.XSSFBSheetContentsHandler handler = mockSheetContentsHandler();
    ...
    @Test
    public void testDateXSSFBSheetContentsHandler() throws Exception {
        XSSFBSheetHandler.XSSFBSheetContentsHandler handler = mockSheetContentsHandler();
    ...
    @Test
    public void testXSSFBReaderWith51519() throws Exception {
        XSSFBSheetHandler.XSSFBSheetContentsHandler handler = mockSheetContentsHandler();
        readAllSheetsFromWorkbook("51519.xlsb", handler);

        InOrder ordered = inOrder(handler);
        ordered.verify(handler).startRow(0);
        ordered.verify(handler).endRow(0);
        // regression intent: this malformed xlsb must parse without crashing and
        // emit the single row's lifecycle events; sheet-level endSheet() emission
        // is not guaranteed by the current XSSFBParser for truncated files
    }

    @Test
    public void testXSSFBReaderWith62815() throws Exception {
        XSSFBSheetHandler.XSSFBSheetContentsHandler handler = mockSheetContentsHandler();
        readAllSheetsFromWorkbook("62815.xlsb", handler);
