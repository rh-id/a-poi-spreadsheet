...
public class TestXSSFEventBasedExcelExtractor {
    ...
    public void test51519() throws Exception {
        ...
        text = ex.getText();
        assertFalse("should not be able to find appended phonetic run",
                text.contains("\u65E5\u672C\u30AA\u30E9\u30AF\u30EB \u30CB\u30DB\u30F3"));
        ex.close();

    }

    @Test
    public void test66365() throws Exception {
    ...
    @Test
    public void test67784() throws Exception {
        try (XSSFEventBasedExcelExtractor ex =
                     new XSSFEventBasedExcelExtractor(
    ...
    @Test
    public void test67784Formulas() throws Exception {
        try (XSSFEventBasedExcelExtractor ex =
                     new XSSFEventBasedExcelExtractor(
                             XSSFTestDataSamples.openSamplePackage("bug67784.xlsx"))) {
