...
/**
 * Tests of implementations of {@link m.co.rh.id.apoi_spreadsheet.org.apache.poi.ss.usermodel.Name}.
 */
public abstract class BaseTestNamedRange {
    ...
    public final void testCreate() throws Exception {
        try (Workbook wb = _testDataProvider.createWorkbook()) {
            ...
            for (String name : invalidNames) {
                assertThrows("should have thrown exceptiuon due to invalid name: " + name,
                        IllegalArgumentException.class, () -> name1.setNameName(name));
            }
        }
    }
    ...
    public final void testMultiNamedRange() throws Exception {
        ...
        assertEquals("Name is " + nm1.getNameName(),
                "RangeTest1", nm1.getNameName());
        assertEquals("Reference is " + nm1.getRefersToFormula(),
                (wb2.getSheetName(0) + "!$A$1:$L$41"), nm1.getRefersToFormula());

        Name nm2 = wb2.getName("RangeTest2");
        assertEquals("Name is " + nm2.getNameName(),
                "RangeTest2", nm2.getNameName());
        assertEquals("Reference is " + nm2.getRefersToFormula(),
                (wb2.getSheetName(1) + "!$A$1:$O$21"), nm2.getRefersToFormula());
    ...
    public final void testPrintAreaRemove() throws Exception {
        try (Workbook workbook = _testDataProvider.createWorkbook()) {
            ...
            assertNull("PrintArea was not removed",
                    workbook.getPrintArea(0));
        }
    }
    ...
    public final void testMultipleNamedWrite() throws Exception {
        ...
        assertEquals("Name is " + nm.getNameName(),
                "RangeTest", nm.getNameName());
        assertEquals("Reference is " + nm.getRefersToFormula(),
                (wb2.getSheetName(0) + "!$D$4:$E$8"), nm.getRefersToFormula());

        nm = wb2.getName("AnotherTest");
        assertEquals("Name is " + nm.getNameName(),
                "AnotherTest", nm.getNameName());
        assertEquals("Reference is " + nm.getRefersToFormula(),
    ...
    public final void testNamedCell_1() throws Exception {
        ...
        assertTrue("Should be exactly 1 cell in the named cell :'" + cellName + "'",
                aref.isSingleCell());
    ...
    public void testValid() throws IOException {
        String[] valids = new String[]{"Hello", "number1", "_underscore", "underscore_", "p.e.r.o.i.d.s", "\\Backslash", "Backslash\\"};
    ...
    @Test
    public void renameSheetWithNamedRangeReferringToUnicodeSheetName() throws IOException {
