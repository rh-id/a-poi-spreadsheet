...
public final class TestXSSFTable {
    ...
    public void testCTTableStyleInfo() throws IOException {
        try (XSSFWorkbook outputWorkbook = new XSSFWorkbook()) {
            ...
            try (XSSFWorkbook inputWorkbook = XSSFTestDataSamples.writeOutAndReadBack(outputWorkbook)) {
                ...
                assertEquals("Tables number",
                        1, tables.size());

                XSSFTable inputTable = tables.get(0);
                assertEquals("Table display name",
                        outputTable.getDisplayName(), inputTable.getDisplayName());

                CTTableStyleInfo inputStyleInfo = inputTable.getCTTable().getTableStyleInfo();
                assertEquals("Style name",
                        outputStyleInfo.getName(), inputStyleInfo.getName());
    ...
    public void findColumnIndex() throws IOException {
        try (XSSFWorkbook wb = XSSFTestDataSamples.openSampleWorkbook("StructuredReferences.xlsx")) {
            ...
            assertEquals("case insensitive",
                    2, table.findColumnIndex("NuMbEr"));
    ...
    public void testCreateColumn() throws IOException {
        try (XSSFWorkbook wb = new XSSFWorkbook()) {
            ...
            assertEquals("Column c ID",
                    1, c1.getId());
            assertTrue("Column B ID",
                    c1.getId() < cB.getId());
            assertTrue("Column D ID",
                    cB.getId() < cD.getId());
            assertTrue("Column C ID",
                    cD.getId() < cC.getId());
            // generated name
    ...
    @Test
    public void testBug65669() throws IOException {
    ...
    @Test
    public void testNamesWithNewLines() throws IOException {
        try (
    ...
    @Test
    public void bug66211() throws IOException {
    ...
    @Test
    public void bug66212() throws IOException {
        try (XSSFWorkbook wb = XSSFTestDataSamples.openSampleWorkbook("table-sample.xlsx")) {
            XSSFTable table = wb.getTable("Tabelle1");
            XSSFSheet sheet = table.getXSSFSheet();
    ...
    @Test
    public void bug66213() throws IOException {
        try (XSSFWorkbook wb = XSSFTestDataSamples.openSampleWorkbook("table-sample.xlsx")) {
    ...
    @Test
    public void testCloneConditionalFormattingSamples() throws IOException {
    ...
    @Test
    public void testCloneSingleCellTable() throws IOException {
        try (XSSFWorkbook wb = XSSFTestDataSamples.openSampleWorkbook("SingleCellTable.xlsx")) {
            wb.cloneSheet(0, "Test");
            try (UnsynchronizedByteArrayOutputStream bos = UnsynchronizedByteArrayOutputStream.builder().get()) {
                wb.write(bos);
