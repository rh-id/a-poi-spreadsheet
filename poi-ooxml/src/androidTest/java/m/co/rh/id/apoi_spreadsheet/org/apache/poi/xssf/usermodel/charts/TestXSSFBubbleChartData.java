...
import m.co.rh.id.apoi_spreadsheet.org.apache.poi.xddf.usermodel.PresetColor;
...
import m.co.rh.id.apoi_spreadsheet.org.apache.poi.xddf.usermodel.chart.XDDFBubbleChartData;
import m.co.rh.id.apoi_spreadsheet.org.apache.poi.xddf.usermodel.chart.XDDFChart;
...
import m.co.rh.id.apoi_spreadsheet.org.apache.poi.xddf.usermodel.chart.XDDFLineChartData;
import m.co.rh.id.apoi_spreadsheet.org.apache.poi.xddf.usermodel.chart.XDDFNumericalDataSource;
import m.co.rh.id.apoi_spreadsheet.org.apache.poi.xddf.usermodel.chart.XDDFPieChartData;
    ...
    private static CTDLbls setDataLabels(XDDFChartData.Series series, int pos, boolean... show) {
        ...
        */
        ...
        if (series instanceof XDDFBarChartData.Series) {
            ...
            if (!(pos == 3 || pos == 4 || pos == 5 || pos == 7))
                pos = 3; // bar chart does not provide other pos
            ...
            if (!(pos == 3 || pos == 1 || pos == 4 || pos == 5))
                pos = 3; // pie chart does not provide other pos
            ctDLbls.addNewDLblPos().setVal(STDLblPos.Enum.forInt(pos));
