...
import m.co.rh.id.apoi_spreadsheet.org.apache.poi.ss.formula.DataValidationEvaluator;
import m.co.rh.id.apoi_spreadsheet.org.apache.poi.ss.formula.eval.ValueEval;
import m.co.rh.id.apoi_spreadsheet.org.apache.poi.ss.usermodel.BaseTestDataValidation;
...
public class TestXSSFDataValidation extends BaseTestDataValidation {
    ...
    public void testTableBasedValidationList() throws IOException {
        try (XSSFWorkbook wb = XSSFTestDataSamples.openSampleWorkbook("dataValidationTableRange.xlsx")) {
            ...
            assertEquals("wrong # of valid values",
                    32, values.size());
        }
    }
}
