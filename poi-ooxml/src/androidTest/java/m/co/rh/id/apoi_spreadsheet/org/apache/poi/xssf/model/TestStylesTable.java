...
public final class TestStylesTable {
    ...
    public void maxNumberOfDataFormats() throws IOException {
        try (XSSFWorkbook wb = new XSSFWorkbook()) {
            ...
            IllegalArgumentException e = assertThrows("Expected to get an IllegalArgumentException(\"Maximum Number of Data Formats must be greater than or equal to 0\")",
                    IllegalArgumentException.class, () -> styles.setMaxNumberOfDataFormats(-1));
