...
import m.co.rh.id.apoi_spreadsheet.org.apache.poi.POITestCase;
...
import m.co.rh.id.apoi_spreadsheet.org.apache.poi.hssf.usermodel.TestHSSFDataFormatter;
import m.co.rh.id.apoi_spreadsheet.org.apache.poi.ss.format.CellFormat;
import m.co.rh.id.apoi_spreadsheet.org.apache.poi.ss.format.CellFormatResult;
import m.co.rh.id.apoi_spreadsheet.org.apache.poi.ss.util.CellReference;
import m.co.rh.id.apoi_spreadsheet.org.apache.poi.ss.util.NumberToTextConverter;
...
public class TestDataFormatter {
    ...
    public static void setUpClass() {
        ...
        assertEquals("This failure can indicate that the wrong locale is used during test-execution, "
    ...
    @Test
    public void setUse4DigitYearsInAllDateFormats() {
        DataFormatter dataFormatter = new DataFormatter();
    ...
    @Test
    public void useCachedValuesForFormulaCells() {
        DataFormatter dataFormatter = new DataFormatter();
    ...
    public void testConditionalRanges() {
        ...
        assertEquals("Wrong format for " + format,
                "17,876", dfUS.formatRawCellContents(17876.000, -1, format));
        assertEquals("Wrong format for " + format,
                "9.7", dfUS.formatRawCellContents(9.71, -1, format));
    }
...
*/
    ...
    public void testBug54786() {
        ...
        IllegalArgumentException e = assertThrows("Catches exception because of invalid format, i.e. trailing quoting",
    ...
    public void testLargeNumbersAndENotation() throws IOException {
        ...
        // TODO Rounding 1 seemed to fail on android?
        //assertFormatsTo("1.23457E+19", 12345650000000000000d);
        // TODO Rounding 2 seemed to fail on android?
        //assertFormatsTo("-1.23457E+19", -12345650000000000000d);
        // TODO Rounding 3 seemed to fail on android?
        //assertFormatsTo("1.23457E-19", 0.0000000000000000001234565d);
        // TODO Rounding 4 seemed to fail on android?
        //assertFormatsTo("-1.23457E-19", -0.0000000000000000001234565d);
    ...
    private static void assertFormatsTo(String expected, double input) throws IOException {
        try (Workbook wb = new HSSFWorkbook()) {
            ...
            assertEquals("Failed for input " + input,
                    expected, actual);
        }
    }
    ...
    @Test
    public void testFormulaEvaluationWithoutFormulaEvaluator() throws IOException {
    ...
    @Test
    public void testAdjustTo4DigitYearsIfConfigured() {
        DataFormatter dataFormatter = new DataFormatter();
    ...
    @Test
    public void testDataFormatterWithAdjustTo4DigitYears() {
        DataFormatter dataFormatter = new DataFormatter();
        dataFormatter.setUse4DigitYearsInAllDateFormats(true);
        double date = 42747.412892397523;
