...
package m.co.rh.id.a_poi_spreadsheet.org.apache.poi.xssf.usermodel;
...
import static m.co.rh.id.a_poi_spreadsheet.org.apache.poi.hssf.HSSFTestDataSamples.openSampleFileStream;
import static m.co.rh.id.a_poi_spreadsheet.org.apache.poi.xssf.XSSFTestDataSamples.getSampleFile;
import static m.co.rh.id.a_poi_spreadsheet.org.apache.poi.xssf.XSSFTestDataSamples.openSampleWorkbook;
import static m.co.rh.id.a_poi_spreadsheet.org.apache.poi.xssf.XSSFTestDataSamples.writeOut;
import static m.co.rh.id.a_poi_spreadsheet.org.apache.poi.xssf.XSSFTestDataSamples.writeOutAndReadBack;
...
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ooxml.POIXMLProperties;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ooxml.TrackingInputStream;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.openxml4j.exceptions.InvalidFormatException;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.openxml4j.opc.ContentTypes;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.openxml4j.opc.OPCPackage;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.openxml4j.opc.PackageAccess;
...
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.openxml4j.opc.ZipPackage;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.openxml4j.opc.internal.FileHelper;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.openxml4j.opc.internal.MemoryPackagePart;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.openxml4j.opc.internal.PackagePropertiesPart;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.openxml4j.util.ZipInputStreamZipEntrySource;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.tests.usermodel.BaseTestXWorkbook;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.usermodel.Cell;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.usermodel.CellReferenceType;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.usermodel.CellStyle;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.usermodel.Comment;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.usermodel.DataFormatter;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.usermodel.Font;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.usermodel.FormulaError;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.usermodel.FormulaEvaluator;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.usermodel.RichTextString;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.usermodel.Row;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.usermodel.Row.MissingCellPolicy;
...
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.usermodel.WorkbookFactory;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.util.AreaReference;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.util.CellAddress;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.ss.util.CellReference;
...
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.xddf.usermodel.chart.XDDFBarChartData;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.xddf.usermodel.chart.XDDFChartData;
import m.co.rh.id.a_poi_spreadsheet.org.apache.poi.xssf.XSSFITestDataProvider;
...
public final class TestXSSFWorkbook extends BaseTestXWorkbook {
    ...
    @Test
    public void existingWithZipEntryTempFiles() throws Exception {
    ...
    @Test
    public void existingWithZipEntryEncryptedTempFiles() throws Exception {
        int defaultThreshold = ZipInputStreamZipEntrySource.getThresholdBytesForTempFiles();
...
//        row.createCell(0).setCellStyle(cs);
    ...
    @Test
    public void test501RC1Failure() throws Exception {
    ...
    @Test
    public void testNewWorkbookWithTempFilePackageParts() throws Exception {
        try (UnsynchronizedByteArrayOutputStream bos = UnsynchronizedByteArrayOutputStream.builder().get()) {
            assertFalse("useTempFilePackageParts defaults to false?", ZipPackage.useTempFilePackageParts());
            assertFalse("encryptTempFilePackageParts defaults to false?", ZipPackage.encryptTempFilePackageParts());
            ZipPackage.setUseTempFilePackageParts(true);
            assertTrue("useTempFilePackageParts was modified?", ZipPackage.useTempFilePackageParts());
            assertFalse("encryptTempFilePackageParts was not modified?", ZipPackage.encryptTempFilePackageParts());
            try (XSSFWorkbook workbook = new XSSFWorkbook()) {
    ...
    public void testNewWorkbookWithEncryptedTempFilePackageParts() throws Exception {
        try (UnsynchronizedByteArrayOutputStream bos = UnsynchronizedByteArrayOutputStream.builder().get()) {
            ...
            assertTrue("useTempFilePackageParts was modified?", ZipPackage.useTempFilePackageParts());
            assertTrue("encryptTempFilePackageParts was modified?", ZipPackage.encryptTempFilePackageParts());
            try (XSSFWorkbook workbook = new XSSFWorkbook()) {
                XSSFSheet sheet = workbook.createSheet("sheet1");
                XSSFRow row = sheet.createRow(0);
                XSSFCell cell0 = row.createCell(0);
    ...
    @Test
    public void testLinkExternalWorkbook() throws Exception {
        ...
        try (
            ...
            assertEquals(Double.valueOf(30.0), Double.valueOf(cell.getNumericCellValue()));
            ...
            try (
                ...
                assertEquals(Double.valueOf(30.0), Double.valueOf(cell2.getNumericCellValue()));
            }
        }
    }

    @Test
    public void testIgnoreTrashParts() throws Exception {
        try (XSSFWorkbook workbook = openSampleWorkbook("Excel_file_with_trash_item.xlsx")) {
            for (PackagePart packagePart : workbook.getPackage().getParts()) {
                assertFalse("should ignore part " + packagePart.getPartName(), packagePart.getPartName().toString().contains("trash"));
            }
        }
    }

    @Test
    public void testCacheExternalWorkbook() throws Exception {
        ...
        try (
            ...
            assertEquals(Double.valueOf(sum), Double.valueOf(cell.getNumericCellValue()));
    ...
    @Test
    public void checkExistingFileForR1C1Refs() throws IOException {
        try (
    ...
    @Test
    public void checkNewFileForR1C1Refs() throws IOException {
        try (
                UnsynchronizedByteArrayOutputStream bos = UnsynchronizedByteArrayOutputStream.builder().get();
                XSSFWorkbook wb = new XSSFWorkbook()
        ) {
    ...
    @Test
    public void testGithub321() throws Exception {
        try (XSSFWorkbook wb = openSampleWorkbook("github-321.xlsx")) {
            ...
            assertEquals(Double.valueOf(2.05), Double.valueOf(a3.getNumericCellValue()));
            ...
            assertEquals(Double.valueOf(2.05), Double.valueOf(a4.getNumericCellValue()));
    ...
    public void testWorkbookCloseClosesInputStream() throws Exception {
        try (TrackingInputStream stream = new TrackingInputStream(
            ...
            assertTrue("stream should be closed by XSSFWorkbook", stream.isClosed());
        }
    }

    @Test
    public void testWorkbookCloseCanBeStoppedFromClosingInputStream() throws Exception {
        try (TrackingInputStream stream = new TrackingInputStream(
                HSSFTestDataSamples.openSampleFileStream("github-321.xlsx"))) {
            ...
            assertFalse("stream should not be closed by XSSFWorkbook", stream.isClosed());
        }
    }

    @Test
    public void readFromZipStream() throws IOException {
    ...
    private static void expectFormattedContent(Cell cell, String value) {
        assertEquals("Cell " + ref(cell) + " has wrong formatted content.", value, new DataFormatter().formatCellValue(cell));
    }
