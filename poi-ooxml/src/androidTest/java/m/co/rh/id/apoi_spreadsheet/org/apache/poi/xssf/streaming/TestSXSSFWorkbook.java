...
import m.co.rh.id.apoi_spreadsheet.org.apache.poi.xssf.usermodel.DefaultIndexedColorMap;
...
import m.co.rh.id.apoi_spreadsheet.org.apache.poi.xssf.usermodel.XSSFFont;
...
public final class TestSXSSFWorkbook extends BaseTestXWorkbook {
    ...
    @Test
    public void useSharedStringsTableWithRichText() throws Exception {
        testUseSharedStringsTableWithRichText(false);
    }

    @Test
    public void useSharedStringsTableWithRichTextAndCompression() throws Exception {
    ...
    public void workbookDispose() throws IOException {
        ...
        for (boolean compressTempFiles : booleans) {
            try (SXSSFWorkbook wb = new SXSSFWorkbook()) {
    ...
    @Test
    public void workbookTempFilesAreDisposedWhenClosingWorkbook() throws IOException {
    ...
    public void bug53515() throws Exception {
        try (Workbook wb1 = new SXSSFWorkbook(10)) {
            ...
            wb1.write(NullOutputStream.INSTANCE);
            wb1.write(NullOutputStream.INSTANCE);
            try (Workbook wb2 = new XSSFWorkbook()) {
                populateWorkbook(wb2);
                wb2.write(NullOutputStream.INSTANCE);
                wb2.write(NullOutputStream.INSTANCE);
            }
        }
    }
    ...
    @Test
    public void addHyperlink() throws Exception {
        try (
                SXSSFWorkbook wb = new SXSSFWorkbook();
                UnsynchronizedByteArrayOutputStream bos = UnsynchronizedByteArrayOutputStream.builder().get()
        ) {
    ...
    @Test
    public void addDimension() throws IOException {
        try (
                SXSSFWorkbook wb = new SXSSFWorkbook();
                UnsynchronizedByteArrayOutputStream bos = UnsynchronizedByteArrayOutputStream.builder().get()
        ) {
    ...
    @Test
    public void addDimension1() throws IOException {
        try (
    ...
    @Test
    public void addDimensionXSSFtoSXSSF() throws IOException {
    ...
    @Test
    public void addDimensionDisabled() throws IOException {
        try (
                SXSSFWorkbook wb = new SXSSFWorkbook();
                UnsynchronizedByteArrayOutputStream bos = UnsynchronizedByteArrayOutputStream.builder().get()
        ) {
    ...
    @Test
    public void getStylesSource() throws IOException {
        try (SXSSFWorkbook workbook = new SXSSFWorkbook()) {
            assertNotNull("style source available",
                    workbook.getXSSFWorkbook().getStylesSource());
            assertNotNull("indexed colors available",
                    workbook.getXSSFWorkbook().getStylesSource().getIndexedColors());
        }
    }

    @Test
    public void dateStyle() throws IOException {
        try (
    ...
    private void testUseSharedStringsTableWithRichText(boolean compressTempFiles) throws Exception {
        try (SXSSFWorkbook wb = new SXSSFWorkbook(null, 10, compressTempFiles, true)) {
            ...
            redFont.setColor(new XSSFColor(Color.valueOf(Color.rgb(241, 76, 93)), new DefaultIndexedColorMap()));
    ...
    @Test
    public void writeBrokenFile() throws IOException {
